...
video_name.bind("<Button-3>", lambda x: rightKey(x, window))
...
video_extension.bind("<Button-3>", lambda x: rightKey(x, window))
...
cookie.bind("<Button-3>", lambda x: rightKey(x, window))
