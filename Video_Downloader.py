...
video_url_text.grid(row=1,column=0,padx=50,pady=15)
video_url = tk.Entry(window)
video_url.place(x = 90,y = 15,width=350,height=18)
save_path_text = tk.Label(window,text="PATH : ",bg='#3c4bb4')
save_path_text.grid(row=2,column=0,padx=45,pady=15)
save_path = tk.Entry(window)
save_path.place(x = 90,y = 67.5,width=350,height=18)
